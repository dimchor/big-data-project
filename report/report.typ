...
Μετά την συσχέτιση των δεδομένων ο άριθμός των εγγραφών είναι μόνο 495 που βρίσκονται στο αρχείο Association.csv,η διαδικασία 
αυτή κυρίως στις πρώτες μορφές που είχε ο αλγόριθμος της έπερνα μέχρι και 10 δευτερόλεπτα για την εκτέλεση της, στον υπάρχντα
...
Επίσης θα μπορούσε να υπάρξει και ισορρόπησή των αποτελεσμάτων μεταξύ των δύο βάσεων δεδομένων με την ενδεχόμενη απαλοιφή
...
ότι με τις σωστές συνθήκες μπορεί πράγματι να προκαλεστεί μια ηφαιστειακή έκρηξη λόγο μιας σεισμικής δόνησης στην περιοχή.
