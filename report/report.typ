...
και επιστρέφει ένα νέο DataFrame που περιέχει τα συχνά σύνολα στοιχείων μαζί με την υποστήριξή τους. Αυτό επιτυγχάνετε με την εύρεση 
...
μέχρι την κατασκευή τριπλέτας δεδομένων και την μη εύρεση  νέων συχνών συνόλων.
...
στην περίπτωση μας των σεισμικών δονήσεων, εως αυτή που έχει την μεγαλύτερη βαρύτητα.Η εκτέλεση τους δεν διέφερε από το φόρτωμα  
...
Αφού έχουμε πραγματοποιήσει την συσχέτιση των δεδομένων με την χρήση του αλγόριθμου apriori 
τελικά αποτελέσματα..............
...
που πρόσκεινται σε αυτό. Εαν γινόταν και αυτή η σύγκριση τα αποτελέσματα ενδεχομένως να διέφεραν σε έναν βαθμό
