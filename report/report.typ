...
και επιστρέφει ένα νέο DataFrame που περιέχει τα συχνά σύνολα στοιχείων μαζί με την υποστήριξή τους TO DO
...
Μετά την συσχέτιση των δεδομένων ο άριθμός των εγγραφών είναι μόνο 495 εγγραφές που βρίσκονται στο αρχείο Association.csv.

τελικά αποτελέσματα

=Κριτική αποτίμηση αποτελεσμάτων

-δεν κοιταζουμε τις γύρω περιοχές
-δεν έχουμε ισό αριθμό δεδομένων
